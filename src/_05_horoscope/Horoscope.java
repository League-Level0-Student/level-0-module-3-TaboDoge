...
public static void main(String[] args) {
	String star_sign = JOptionPane.showInputDialog("What is your star sign?");
	if  (star_sign.equals("Aries")) {
	...
	else if(star_sign.equals("Taurus")) {
	...
	else if(star_sign.equals("Gemini")) {
	...
	else if(star_sign.equals("Cancer")) {
	...
	else if(star_sign.equals("Virgo")) {
	...
	else if(star_sign.equals("Libra")) {
	...
	else if(star_sign.equals("Scorpio")) {
	...
	else if(star_sign.equals("Sagittarius")) {
	...
	else if(star_sign.equals("Capricorn")) {
	...
	else if(star_sign.equals("Aquarius")) {
	...
	else if(star_sign.equals("Pisces")) {
		...
		JOptionPane.showMessageDialog(null, "Please enter a valid sign");
	}
